    ...
    try {
      ...
      if (successes.length > 0) {
        ...
        if (groupId) {
          ...
          setTimeout(() => {
            router.push(`/activities_autres/${activityId}/groups/${groupId}`);
          }, 1500);
        } else {
          ...
          setTimeout(() => {
            ...
            router.push(`/corrections_autres?activityId=${activityId}&highlight=${validCorrectionIds}&correctionId=${validCorrectionIds}`);
          }, 1500);
        }
      }
