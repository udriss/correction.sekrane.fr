...
export default function ClassesLayout({
  ...
  const getBreadcrumbConfig = () => {
    ...
    // Page des étudiants d'une classe
      ...
      extraItems = [
        { label: `Classe #${classId}`, href: `/classes/${classId}`, icon: <SchoolIcon fontSize="small" /> }
      ];
    ...
    // Page pour ajouter une correction à une classe
      ...
      extraItems = [
        { label: `Classe #${classId}`, href: `/classes/${classId}`, icon: <SchoolIcon fontSize="small" /> },
        { label: 'Corrections', href: `/classes/${classId}/corrections`, icon: <AssignmentIcon fontSize="small" /> }
      ];
    ...
    // Page d'un étudiant dans une classe
      ...
      extraItems = [
        { label: `Classe #${classId}`, href: `/classes/${classId}`, icon: <SchoolIcon fontSize="small" /> },
        { label: 'Étudiants', href: `/classes/${classId}/students`, icon: <PeopleIcon fontSize="small" /> }
      ];
